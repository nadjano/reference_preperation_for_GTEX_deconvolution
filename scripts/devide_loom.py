...
ds = loompy.connect('adult_human_20221007.loom')
annotation = pd.read_excel("annotation.xlsx")
map_dict = annotation.set_index("Cluster")["cellType"].to_dict()
...
for tissue in tissues:
    ...
    loompy.create(tissue+'_5000.loom', counts_sub, row_attrs, col_attrs)
