...
#input h5 data
T1L.data <- Read10X_h5("sc_THYROID/T1L.h5", use.names = T)
T1R.data <- Read10X_h5("sc_THYROID/T1R.h5", use.names = T)
T2L.data <- Read10X_h5("sc_THYROID/T2L.h5", use.names = T)
T2R.data <- Read10X_h5("sc_THYROID/T2R.h5", use.names = T)
T3L.data <- Read10X_h5("sc_THYROID/T3L.h5", use.names = T)
T3R.data <- Read10X_h5("sc_THYROID/T3R.h5", use.names = T)
NT.data <- Read10X_h5("sc_THYROID/NT.h5", use.names = T)
...
thyroid.combined <- IntegrateData(anchorset = thyroid.anchors, dims = 1:30)
thyroid.combined

#Perform an integrated analysis

DefaultAssay(thyroid.combined) <- "integrated"
saveRDS(thyroid.combined, 'new_thyroid.rds')
#NormalizeData
...
thyroid.combined = readRDS('sc_THYROID/new_thyroid.rds')
...
thyroid.combined@meta.data$stim <- factor(thyroid.combined@meta.data$stim, 
                                          levels = c("LEFT1", "LEFT2", "LEFT3", "Normal", "RIGHT1", "RIGHT2", "RIGHT3"), 
